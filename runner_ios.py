...
from ROAR.agent_module.roarmania_agent import RoarmaniaAgent
...
if __name__ == '__main__':
    ...
    try:
        ...
        if success or args.reconnect is False:
            agent = RoarmaniaAgent(vehicle=Vehicle(), agent_settings=agent_config, should_init_default_cam=True)
            if args.use_unity:
